...
<body>
	...
	<table width='80%' border=0>
		...
		while($res = mysqli_fetch_array($result)) {		
			...
			echo "<td><a href=\"edit.php?id=$res[kode_barang]\">Edit</a> | <a href=\"delete.php?id=$res[kode_barang]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
		}
		?>
	</table>	
</body>
